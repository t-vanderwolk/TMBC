...
export const onboardingApi = {
  requestInvite: (payload: { name?: string; email: string; city?: string; dueDate?: string }) =>
    api.post('/onboarding/request-invite', payload),
  verifyCode: (payload: { email: string; code: string }) => api.post('/onboarding/verify-code', payload),
  createProfile: (payload: { email: string; name: string }) =>
    api.post('/onboarding/create-profile', payload),
};
