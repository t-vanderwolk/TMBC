...
export const useMyRegistry = () => {
  return useMemo(() => {
    const signupUser = async (payload: SignupUserInput): Promise<ApiResponse> => {
      const response = await api.post<ApiResponse>("/registry/myregistry/signup", payload);
      return response.data;
    };

    const searchRegistries = async (params: SearchRegistriesParams): Promise<ApiResponse> => {
      const response = await api.get<ApiResponse>("/registry/myregistry/search", { params });
      return response.data;
    };

    const getRegistries = async (params: GetRegistriesParams): Promise<ApiResponse> => {
      const response = await api.get<ApiResponse>("/registry/myregistry/registries", { params });
      return response.data;
    };

    const getRegistryItems = async (params: GetRegistryItemsParams): Promise<ApiResponse> => {
      const response = await api.get<ApiResponse>("/registry/myregistry/items", { params });
      return response.data;
    };

    const addItem = async (payload: AddItemInput): Promise<ApiResponse> => {
      const response = await api.post<ApiResponse>("/registry/myregistry/items/add", payload);
      return response.data;
    };

    const updateItem = async (payload: UpdateItemInput): Promise<ApiResponse> => {
      const response = await api.post<ApiResponse>("/registry/myregistry/items/update", payload);
      return response.data;
    };

    const removeItem = async (payload: RemoveItemInput): Promise<ApiResponse> => {
      const response = await api.post<ApiResponse>("/registry/myregistry/items/remove", payload);
      return response.data;
    };

    const markPurchased = async (payload: MarkPurchasedInput): Promise<ApiResponse> => {
      const response = await api.post<ApiResponse>("/registry/myregistry/items/purchased", payload);
      return response.data;
    };
