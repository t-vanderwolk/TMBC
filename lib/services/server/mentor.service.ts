...
export type MemberOverviewModule = {
  title: string;
  progress: number;
  note: string;
};

export type MemberOverviewRegistry = {
  title: string;
  note: string;
};

export type MemberOverviewEvent = {
  title: string;
  date: string;
  note: string;
};
...
export type MemberOverview = {
  ...
  mentorName: string;
  mentorId: string;
  modules: MemberOverviewModule[];
  registryHighlights: MemberOverviewRegistry[];
  events: MemberOverviewEvent[];
  mentorNotes: string[];
};
...
const memberOverviewData: Record<string, MemberOverview> = {
  'mentee-1': {
    memberId: 'mentee-1',
...
export const getMentorNotes = async (mentorId: string): Promise<MentorNoteSummary[]> => {
...
export const getMentorMemberOverview = async (mentorId: string, memberId: string): Promise<MemberOverview> => {
