  ...
  return (
    <section className="rounded-[32px] border border-[var(--tmbc-mauve)]/30 bg-[var(--tmbc-ivory)]/80 p-6 shadow-[0_25px_70px_rgba(199,166,199,0.25)]">
      <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-[0.65rem] uppercase tracking-[0.45em] text-[var(--tmbc-charcoal)] text-opacity-60">Momentum line</p>
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="flex justify-between text-[0.65rem] font-semibold uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)] text-opacity-60">
          ...
          <span
            ...
            className={`rounded-full border px-4 py-1 text-[0.65rem] uppercase tracking-[0.35em] ${
              milestone.achieved
                ...
                : 'border-[var(--tmbc-charcoal)]/20 bg-white/70 text-[var(--tmbc-charcoal)] text-opacity-80'
            }`}
          >
