      ...
      {conversations.map((conversation) => (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-[0.6rem] uppercase tracking-[0.35em] text-[var(--tmbc-charcoal)] text-opacity-60">
              {conversation.time}
            </span>
          </div>
          <p className="mt-2 text-xs text-[var(--tmbc-charcoal)] text-opacity-70">{conversation.detail}</p>
          <p className="text-[0.7rem] text-[var(--tmbc-charcoal)] text-opacity-60">{conversation.lastMessage}</p>
          {conversation.unread && (
