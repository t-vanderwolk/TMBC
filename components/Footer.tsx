  ...
  return (
    <footer className="relative overflow-hidden rounded-[48px] border border-[var(--tmbc-mauve)] bg-gradient-to-br from-[var(--tmbc-blush)] via-[var(--tmbc-ivory)] to-[var(--tmbc-charcoal)]/5 px-8 py-12 text-[var(--tmbc-charcoal)] shadow-[0_35px_90px_rgba(199,166,199,0.3)]">
      <div className="pointer-events-none absolute inset-0 opacity-20">
        <div className="flex h-full items-center justify-center text-[6rem] uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)] text-opacity-10">
          TM
        </div>
      </div>

      <div className="relative mx-auto grid max-w-screen-xl gap-8 text-center md:grid-cols-3 md:text-left">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.5em] text-[var(--tmbc-charcoal)] text-opacity-60">About</p>
        ...
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.5em] text-[var(--tmbc-charcoal)] text-opacity-60">For Parents</p>
          <div className="space-y-1">
            ...
            <Link
              ...
              className="block text-[0.85rem] text-[var(--tmbc-charcoal)] text-opacity-80 transition hover:text-[var(--tmbc-mauve)]"
            >
              FAQs
            </Link>
            <a
      ...
      <div className="relative mt-10 border-t border-[var(--tmbc-charcoal)]/20 pt-6 text-center text-[0.7rem] uppercase tracking-[0.3em] text-[var(--tmbc-charcoal)] text-opacity-60">
