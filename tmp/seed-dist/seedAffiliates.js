...
const metadataPath = path_1.default.resolve(__dirname, "../data/admin-affiliate-metadata.json");
...
function buildRegistrySettings(entry, existing) {
    ...
    return {
        retailerTier: entry.retailerTier ?? prior?.retailerTier ?? undefined,
        priority: entry.priority ?? (typeof prior?.priority === "number" ? prior.priority : undefined) ?? undefined,
