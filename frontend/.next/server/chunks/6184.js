exports.id=6184,exports.ids=[6184],exports.modules={95694:e=>{e.exports={style:{fontFamily:"'__greatVibes_c5b294', '__greatVibes_Fallback_c5b294'",fontWeight:400},className:"__className_c5b294",variable:"__variable_c5b294"}},59658:(e,t,a)=>{Promise.resolve().then(a.bind(a,34026))},21168:(e,t,a)=>{Promise.resolve().then(a.t.bind(a,2583,23)),Promise.resolve().then(a.t.bind(a,26840,23)),Promise.resolve().then(a.t.bind(a,38771,23)),Promise.resolve().then(a.t.bind(a,13225,23)),Promise.resolve().then(a.t.bind(a,9295,23)),Promise.resolve().then(a.t.bind(a,43982,23))},39427:(e,t,a)=>{Promise.resolve().then(a.t.bind(a,61476,23))},19487:()=>{},34026:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>u});var r=a(95344),s=a(56506),o=a(3729),n=a(95694),i=a.n(n),l=a(98400);let d=[{label:"How It Works",href:"/how-it-works"},{label:"Experience",href:"/experience"},{label:"Community",href:"/community"},{label:"Membership",href:"/membership"},{label:"Blog",href:"/blog"}],h=()=>{let[e,t]=(0,o.useState)(!1);return(0,o.useEffect)(()=>{let e=()=>t(window.scrollY>40);return e(),window.addEventListener("scroll",e,{passive:!0}),()=>window.removeEventListener("scroll",e)},[]),r.jsx("header",{className:`sticky top-0 z-50 bg-[var(--tmbc-ivory)]/80 backdrop-blur-xl transition-all duration-300 ${e?"shadow-[0_15px_45px_rgba(62,47,53,0.15)]":"shadow-none"}`,children:(0,r.jsxs)("div",{className:`mx-auto flex max-w-screen-xl items-center justify-between gap-6 px-6 ${e?"py-3":"py-5"}`,children:[(0,r.jsxs)(s.default,{href:"/",className:"space-y-1 text-ellipsis whitespace-nowrap",children:[r.jsx("p",{className:`${i().className} transition-all duration-300 ${e?"text-2xl":"text-3xl"} text-[var(--tmbc-mauve)]`,children:"Taylor-Made"}),r.jsx("p",{className:"text-[0.55rem] uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)]/70",children:"Baby Co."})]}),r.jsx("nav",{className:"hidden items-center gap-6 text-[0.65rem] uppercase tracking-[0.3em] text-[var(--tmbc-charcoal)]/80 md:flex",children:d.map(e=>r.jsx(s.default,{href:e.href,className:"transition hover:text-[var(--tmbc-mauve)]",children:e.label},e.href))}),(0,r.jsxs)("div",{className:"flex items-center gap-3 text-[0.55rem] uppercase tracking-[0.35em]",children:[r.jsx(s.default,{href:l.M,className:"rounded-[999px] border border-[var(--tmbc-mauve)] px-4 py-2 text-[var(--tmbc-charcoal)] transition hover:border-[var(--tmbc-gold)] hover:text-[var(--tmbc-mauve)]",children:"Log in"}),r.jsx(s.default,{href:"/request-invite",className:"rounded-[32px] border border-[var(--tmbc-gold)] bg-gradient-to-r from-[var(--tmbc-blush)] to-[var(--tmbc-mauve)] px-5 py-2 text-[var(--tmbc-charcoal)] font-semibold tracking-[0.35em] shadow-[0_15px_45px_rgba(212,181,121,0.25)] transition hover:shadow-[0_25px_70px_rgba(212,181,121,0.35)]",children:"Request Invite"})]})]})})},c=()=>(0,r.jsxs)("footer",{className:"relative overflow-hidden rounded-[48px] border border-[var(--tmbc-mauve)] bg-gradient-to-br from-[var(--tmbc-blush)] via-[var(--tmbc-ivory)] to-[var(--tmbc-charcoal)]/5 px-8 py-12 text-[var(--tmbc-charcoal)] shadow-[0_35px_90px_rgba(199,166,199,0.3)]",children:[r.jsx("div",{className:"pointer-events-none absolute inset-0 opacity-20",children:r.jsx("div",{className:"flex h-full items-center justify-center text-[6rem] uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)]/10",children:"TM"})}),(0,r.jsxs)("div",{className:"relative mx-auto grid max-w-screen-xl gap-8 md:grid-cols-3",children:[(0,r.jsxs)("div",{className:"space-y-2",children:[r.jsx("p",{className:"text-xs uppercase tracking-[0.5em] text-[var(--tmbc-charcoal)]/60",children:"About"}),r.jsx("p",{className:"text-[0.9rem] leading-relaxed text-[var(--tmbc-charcoal)]",children:"Invite-only concierge care that lets you learn, plan, and connect with calm confidence."}),r.jsx("p",{className:"text-[0.65rem] uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)]/70",children:"Learn \xb7 Plan \xb7 Connect"})]}),(0,r.jsxs)("div",{className:"space-y-2",children:[r.jsx("p",{className:"text-xs uppercase tracking-[0.5em] text-[var(--tmbc-charcoal)]/60",children:"For Parents"}),r.jsx(s.default,{href:"/request-invite",className:"block text-[0.9rem] font-semibold text-[var(--tmbc-mauve)] transition hover:text-[var(--tmbc-gold)]",children:"Request invite"}),r.jsx(s.default,{href:"/membership#faqs",className:"block text-[0.85rem] text-[var(--tmbc-charcoal)]/80 transition hover:text-[var(--tmbc-mauve)]",children:"FAQs"}),r.jsx("a",{href:"mailto:hello@taylormadebaby.co",className:"block text-[0.85rem] text-[var(--tmbc-charcoal)]/80 transition hover:text-[var(--tmbc-mauve)]",children:"Contact"})]}),(0,r.jsxs)("div",{className:"space-y-2",children:[r.jsx("p",{className:"text-xs uppercase tracking-[0.5em] text-[var(--tmbc-charcoal)]/60",children:"For Mentors & Partners"}),r.jsx("a",{href:"mailto:hello@taylormadebaby.co?subject=Mentor%20interest",className:"block text-[0.9rem] font-semibold text-[var(--tmbc-mauve)] transition hover:text-[var(--tmbc-gold)]",children:"Mentor interest"}),r.jsx("a",{href:"mailto:hello@taylormadebaby.co?subject=Brand%20partnerships",className:"block text-[0.85rem] text-[var(--tmbc-charcoal)]/80 transition hover:text-[var(--tmbc-mauve)]",children:"Brand partnerships"}),r.jsx("p",{className:"text-[0.65rem] uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)]/70",children:"Invite-only \xb7 Concierge community"})]})]}),(0,r.jsxs)("div",{className:"relative mt-10 border-t border-[var(--tmbc-charcoal)]/20 pt-4 text-center text-[0.7rem] uppercase tracking-[0.3em] text-[var(--tmbc-charcoal)]/60",children:["\xa9 ",new Date().getFullYear()," Taylor-Made Baby Co. \xb7 Baby prep, Taylor-Made."]})]});function u({children:e}){return(0,r.jsxs)("div",{className:"min-h-screen overflow-hidden bg-gradient-to-b from-[var(--tmbc-ivory)] via-[var(--tmbc-blush)]/60 to-[var(--tmbc-ivory)] text-[var(--tmbc-charcoal)]",children:[r.jsx(h,{}),r.jsx("main",{className:"space-y-16 px-6 py-12 md:px-10 lg:px-16 xl:px-20",children:e}),r.jsx("div",{className:"px-6 pb-10 md:px-10 lg:px-16 xl:px-20",children:r.jsx(c,{})})]})}},98400:(e,t,a)=>{"use strict";a.d(t,{B:()=>o,M:()=>r});let r="/(marketing)/login",s=e=>(e??"").toLowerCase();function o(e){switch(s(e)){case"member":return"/dashboard/member";case"mentor":return"/dashboard/mentor";case"admin":return"/dashboard/admin";default:return r}}},56506:(e,t,a)=>{"use strict";a.d(t,{default:()=>s.a});var r=a(61476),s=a.n(r)},3565:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>d,metadata:()=>l});var r=a(25036);let s=(0,a(86843).createProxy)(String.raw`/Users/taylorvanderwolk/Desktop/code/TMBC/frontend/components/marketing/MarketingLayout.tsx`),{__esModule:o,$$typeof:n}=s,i=s.default,l={title:"Taylor-Made Baby Co. - Concierge birth & baby planning"};function d({children:e}){return r.jsx(i,{children:e})}},82917:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>u,metadata:()=>c});var r=a(25036);a(7633);var s=a(61041),o=a.n(s),n=a(95609),i=a.n(n),l=a(26672),d=a.n(l);let h=process.env.NEXT_PUBLIC_SITE_URL??"http://localhost:3000",c={title:"Taylor-Made Baby Co.",description:"Concierge-style baby prep for intentional families.",metadataBase:new URL(h)};function u({children:e}){return r.jsx("html",{lang:"en",className:`${o().variable} ${i().variable} ${d().variable}`,children:r.jsx("body",{className:"min-h-screen bg-tmIvory font-sans text-tmCharcoal",children:r.jsx("main",{className:"flex min-h-screen flex-col px-4 pb-16 pt-10 md:px-10 lg:px-16",children:e})})})}},20642:(e,t,a)=>{"use strict";a.d(t,{n:()=>r});let r=[{slug:"best-strollers-2025",title:"Best Strollers of 2025: Taylor-Made Baby Co. Expert Breakdown",description:"Choosing a stroller in 2025? Our CPST-guided breakdown covers the best models for lifestyle, safety, travel, terrains, twins, and budgets.",heroImage:null,date:"2024-03-05",tags:["Gear","Strollers","Registry"],readTime:"8 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Best Strollers of 2025 — Taylor-Made Baby Co.’s Expert Breakdown
...
You don’t need the fanciest model—you need the one tailored to your terrain, car trunk, doorway, and daily rhythm. Inside the Taylor-Made Baby Academy we map gear to lifestyle, budget, and upcoming milestones.
    ...
    > ✨ Want personalized stroller guidance? **[Request an Invite](https://www.taylormadebaby.co/request-invite)** and meet your mentor.`},{slug:"car-seat-safety-101",title:"Car Seat Safety 101: CPST-Guided Tips Every Parent Should Know",description:"A CPST-guided crash course covering installation, harnessing, rear-facing timelines, travel rules, and the most common mistakes parents make.",heroImage:null,date:"2024-02-26",tags:["Safety","Car Seats","CPST"],readTime:"7 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Car Seat Safety 101 — CPST Tips Every Parent Should Know
...
Virtual or in-person, our Taylor-Made mentors double-check harness height, tether routing, recline indicators, and chest clip placement.
    ...
    > ✨ Want a CPST to check your install? **[Request an Invite](https://www.taylormadebaby.co/request-invite)** and we’ll walk you through it.`},{slug:"newborn-essentials-checklist",title:"Newborn Essentials Checklist — What You Actually Need",description:"Lean into curated basics so your first weeks at home feel calm, cozy, and clutter-free.",heroImage:null,date:"2024-02-10",tags:["Newborn","Checklist","Postpartum"],readTime:"6 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Newborn Essentials Checklist
...
Create a small tray with postpartum care items (peri bottles, herbal sprays, comfy robes) and tuck notes with affirmations for middle-of-the-night lifts.`},{slug:"stress-free-baby-registry",title:"How to Build a Stress-Free Baby Registry",description:"Our concierge team shows you how to align your registry with your rituals, not trends.",heroImage:null,date:"2024-02-01",tags:["Registry","Planning","Concierge"],readTime:"9 min read",author:"Taylor-Made Baby Co. Mentors",content:`# How to Build a Stress-Free Baby Registry
...
Book a mentor call before publishing your registry publicly. We’ll trim duplicates, add experience gifts, and build group gifting options.`},{slug:"nursery-trends-2025",title:"Nursery Trends 2025 — What’s In, What’s Out",description:"From statement lighting to wellness tech, here’s how mentors are styling nurseries for 2025.",heroImage:null,date:"2024-01-20",tags:["Nursery","Design","Trends"],readTime:"5 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Nursery Trends 2025
...
## Wellness tech
Smart humidifiers and air quality monitors integrate with concierge dashboards for a balanced environment.`},{slug:"traveling-with-baby-gear",title:"Traveling With Baby — Gear Recommendations from the Pros",description:"Make flights, road trips, and hotel stays feel like a curated retreat with these TMBC-tested picks.",heroImage:null,date:"2024-01-10",tags:["Travel","Gear","Family"],readTime:"7 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Traveling With Baby
...
## Concierge bonus
Upload your itinerary and we’ll annotate with vendor contacts, nanny services, and local resources.`},{slug:"baby-gear-mistakes",title:"Baby Gear Mistakes We See Every Day (And How to Avoid Them)",description:"Skip the overwhelm with this curated list of avoidable gear mishaps straight from our mentor inbox.",heroImage:null,date:"2023-12-28",tags:["Gear","Mentor Tips"],readTime:"6 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Baby Gear Mistakes We See Every Day
...
## Forgetting support
Schedule onboarding sessions for pumps, carriers, or monitors so you’re not troubleshooting at 3am.`},{slug:"choosing-the-right-stroller",title:"Choosing the Right Stroller: Lifestyle-Based Guide",description:"Match your stroller to your day-to-day—city, suburb, or global jet-setter.",heroImage:null,date:"2023-12-10",tags:["Strollers","Lifestyle"],readTime:"5 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Choosing the Right Stroller
...
## Jet-set families
Prioritize quick folds, padded travel bags, and airline-friendly weight limits.`},{slug:"nuna-sena-paal-cove-comparison",title:"Nuna SENA vs. Nuna PAAL vs. Nuna COVE — Which One Is Taylor-Made for You?",description:"Your warm, witty, mentor-guided comparison of the Nuna SENA, PAAL, and COVE—helping you choose the right sleep + play setup for your home and travel life.",heroImage:null,date:"2024-03-10",tags:["Gear","Sleep","Travel","Nuna"],readTime:"8 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Nuna SENA vs. Nuna PAAL vs. Nuna COVE  
...
✨ **Learn \xb7 Plan \xb7 Connect — the Taylor-Made way.** ✨`},{slug:"baby-sleep-solutions-guide",title:"Baby Sleep Solutions Guide: Pros & Cons of Every Option",description:"A warm, mentor-guided breakdown of all the major newborn and infant sleep solutions—bedside bassinets, pack & plays, cribs, mini cribs, and the category of automatic bassinets.",heroImage:null,date:"2024-03-12",tags:["Sleep","Newborn","Gear","Nursery"],readTime:"9 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Baby Sleep Solutions: What’s Worth It, What’s Optional, and What’s Actually Helpful  
...
✨ **Learn \xb7 Plan \xb7 Connect — the Taylor-Made way.** ✨`},{slug:"baby-bottle-buying-guide",title:"Bottles 101: Glass or Plastic? Anti-Colic? Nipple Shape & Flow Explained",description:"A warm, mentor-guided breakdown of bottle materials, anti-colic systems, nipple shapes, sizes, materials, and how to choose the right setup for your baby.",heroImage:null,date:"2024-03-14",tags:["Feeding","Newborn","Gear","Bottles"],readTime:"10 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Bottles, Nipples & All the Confusing Stuff in Between  
...
✨ **Learn \xb7 Plan \xb7 Connect — the Taylor-Made way.** ✨`},{slug:"bringing-baby-home-with-animals",title:"Bringing Baby Home to a House With Animals — A Taylor-Made Guide to Safety, Harmony & Happy Tails",description:"Your mentor-guided roadmap for introducing your baby to pets safely, calmly, and confidently — featuring prep steps, first-introduction guidance, and long-term household harmony.",heroImage:null,date:"2024-03-16",tags:["Family","Postpartum","Pets","Safety"],readTime:"8 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Bringing Baby Home to a House With Animals  
...
✨ **Learn \xb7 Plan \xb7 Connect — the Taylor-Made way.** ✨`},{slug:"baby-boy-checklist",title:"Baby Boy Checklist — Taylor-Made Essentials",description:"A curated, clutter-free baby boy checklist covering clothing, sleep, feeding, diapering, bath, nursery, and travel essentials.",heroImage:"https://images.unsplash.com/photo-1522770179533-24471fcdba45?auto=format&fit=crop&w=1200&q=80",date:"2024-03-18",tags:["Checklist","Newborn","Boy","Planning"],readTime:"4 min read",author:"Taylor-Made Baby Co. Mentors",content:`# Baby Boy Checklist — Taylor-Made Essentials
...
Download the printable checklist PDF above!`}]},16274:(e,t,a)=>{"use strict";a.d(t,{default:()=>s.a});var r=a(48026),s=a.n(r)},48026:(e,t,a)=>{"use strict";let{createProxy:r}=a(86843);e.exports=r("/Users/taylorvanderwolk/Desktop/code/TMBC/frontend/node_modules/next/dist/client/link.js")},7633:()=>{}};