...
const onboarding_routes_2 = __importDefault(require("./routes/mvp/onboarding.routes"));
...
appInstance.use('/api/onboarding', onboarding_routes_2.default);
...
appInstance.use('/api/admin/login-events', authMiddleware_1.requireAdminAuth, admin_loginEvents_routes_1.default);
appInstance.use('/api/admin/overview', authMiddleware_1.requireAdminAuth, admin_overview_routes_1.default);
