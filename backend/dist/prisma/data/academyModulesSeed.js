...
exports.academyModulesSeed = void 0;
exports.academyModulesSeed = [
    {
        ...
        "description": "Transform intentions into a serene space for baby and caregiver",
    ...
    },
    {
        ...
        "description": "Design with ergonomics and rhythm in mind",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "Beyond aesthetics-understanding how furniture supports caregiving."
            ],
            "lecture": [
    ...
    },
    {
        ...
        "description": "Integrate safety and calm design principles",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "Serenity and safety coexist through intentional planning."
            ],
            "lecture": [
                "A serene space is one that feels secure. Parents often associate safety with stress-outlet covers, anchors, and long checklists-but safety can actually free you to relax once the groundwork is done.",
    ...
    },
    {
        ...
        "description": "Use color and touch to nurture emotional comfort",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "Color and texture shape how your nursery feels more than any single product."
            ],
            "lecture": [
                "Science meets sentiment here. Studies show that warm neutrals and soft hues calm both infant heart rates and adult stress levels. While trends come and go, timeless tones like sage, blush, ivory, and sand feel safe to our nervous systems. Your palette should comfort, not compete.",
    ...
    },
    {
        ...
        "description": "Maximize every inch without losing elegance",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "Even the smallest nurseries can feel expansive when designed intentionally."
            ],
            "lecture": [
                "Tiny rooms build big creativity. Think beyond traditional layouts-floating cribs, fold-away changers, and dual-purpose dressers can transform a single corner into a caregiving command center. Multi-use furniture is the unsung hero of modern parenting.",
    ...
    },
    {
        ...
        "description": "Design invisible comfort for rest and health",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "Invisible details-air, scent, and sound-have visible impact on baby wellness."
            ],
            "lecture": [
                "Air quality, gentle fragrance, and sound control are the unsung heroes of serenity. Babies breathe twice as fast as adults, making purifiers and non-toxic diffusers more than luxuries-they're health tools. Subtle scents like lavender or chamomile can cue calm when used sparingly and safely.",
    ...
    },
    {
        ...
        "description": "Ready the space for baby's first day home",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "nursery",
        "content": {
            "explore": [
                "This final step ties your design, organization, and care systems together before baby's arrival."
            ],
            "lecture": [
                "By now your nursery is more than a room-it's an ecosystem. This final module walks you through a gentle pre-baby inspection: safety anchors tightened, swaddles washed, monitor synced, nightlight tested. You'll also learn time-saving habits for those hazy first weeks, like creating a rotating laundry bin or designating a midnight feeding station.",
    ...
    },
    {
        ...
        "description": "Match the perfect stroller to your family's rhythm",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
    ...
    },
    {
        ...
        "description": "Confidence through certified guidance",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Safety meets practicality. This session builds confidence in selecting and installing a car seat."
            ],
            "lecture": [
                "We unpack NHTSA standards, seat types (infant, convertible, booster), expiration rules, and installation best practices. Demonstrations highlight common errors and easy prevention steps.",
    ...
    },
    {
        ...
        "description": "Freedom meets bonding through baby-wearing",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Baby-wearing blends freedom with bonding."
            ],
            "lecture": [
                "Carrying your baby close doesn't just keep your hands free-it nurtures oxytocin and confidence. Whether structured carriers, slings, or wraps, each choice shapes posture, comfort, and connection.",
    ...
    },
    {
        ...
        "description": "Simplify feeding through thoughtful systems",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Feeding evolves quickly-prepare tools for each phase."
            ],
            "lecture": [
                "Feeding gear is one of the most overwhelming product categories for new parents, but also the most rewarding once you understand your rhythm. This module covers bottle systems, sterilizers, pumps, and storage-all through the lens of convenience and emotional well-being.",
    ...
    },
    {
        ...
        "description": "Create rhythms that comfort both baby and parent",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Rest is an ecosystem of rhythm, not routine."
            ],
            "lecture": [
                "Sleep success begins with setup. Bassinets, sound machines, and monitors create cues of consistency for baby-and relief for you. We'll explore safe-sleep standards and the psychology behind gentle conditioning, helping your baby learn comfort without rigid scheduling.",
    ...
    },
    {
        ...
        "description": "Simplify safety and peace of mind with smart tools",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Smart gear should make life easier, not busier."
            ],
            "lecture": [
                "Today's nursery tech has evolved far beyond the old walkie-talkie monitors. From wearable breathing sensors to cameras with cry detection, technology offers parents new levels of reassurance-but also new levels of overwhelm. This module helps you filter the hype from the helpful.",
    ...
    },
    {
        ...
        "description": "Adventure-ready setups for confident mobility",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Parenthood doesn't cancel adventure-it redefines it."
            ],
            "lecture": [
                "Whether you're road-tripping to grandparents or jetting off for a baby-moon 2.0, portable gear is your new best friend. Travel systems, lightweight strollers, compact bassinets, and clip-on highchairs all keep life mobile without sacrificing comfort.",
    ...
    },
    {
        ...
        "description": "Prevent accidents through calm, proactive design",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Safety doesn't mean stress-it means foresight."
            ],
            "lecture": [
                "Every new parent eventually has that moment: your baby starts to roll, crawl, or reach for the dog bowl, and suddenly the living room looks like an obstacle course. This module breaks down baby-proofing into calm, practical steps.",
    ...
    },
    {
        ...
        "description": "Choose toys that nurture imagination and growth",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Play is a baby's first language-gear should support that conversation."
            ],
            "lecture": [
                "This module explores developmental play gear for the first 12 months: play gyms, sensory toys, activity mats, and seats. You'll learn how variety-not quantity-drives engagement. Babies don't need a toy store; they need experiences.",
    ...
    },
    {
        ...
        "description": "Keep your investment clean, safe, and circular",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "gear",
        "content": {
            "explore": [
                "Good gear lasts longer-and helps future families too."
            ],
            "lecture": [
                "From strollers to swings, baby gear takes a beating. This module teaches you how to extend lifespan through proper cleaning, storage, and resale. We'll walk through non-toxic cleaners for fabrics, safe lubrication for stroller wheels, and best practices for gear sharing.",
    ...
    },
    {
        ...
        "description": "Honor your body's healing timeline with nurturing rituals",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Recovery is not a return to the old self-it's an evolution."
            ],
            "lecture": [
    ...
    },
    {
        ...
        "description": "Build confidence in your family's feeding rhythm-whatever it looks like",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Feeding is a relationship, not a task."
            ],
            "lecture": [
    ...
    },
    {
        ...
        "description": "Sustain energy and calm through micro-habits",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
    ...
    },
    {
        ...
        "description": "Rediscover connection while adapting to parenthood",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Parenthood shifts partnerships and communication patterns."
            ],
            "lecture": [
                "Every birth story changes a love story. Partners move from romance to teamwork, and it takes conscious effort to stay connected. We explore emotional check-ins, gratitude habits, and redefining intimacy in the fog of sleep deprivation.",
    ...
    },
    {
        ...
        "description": "Curate your circle with intention and grace",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "It takes a village-but you get to curate yours."
            ],
            "lecture": [
                "Support is medicine. This module helps you identify who energizes you versus who drains you. Building a postpartum network means assigning clear roles: who's the meal person, who's the listener, who's on standby for chores.",
    ...
    },
    {
        ...
        "description": "Normalize the full emotional range of new parenthood",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Your mind deserves as much preparation as your nursery."
            ],
            "lecture": [
                "Postpartum emotions exist on a spectrum-from tender awe to total meltdown. This module creates space for all of it. We talk honestly about 'baby blues' versus postpartum depression and anxiety, not to alarm you, but to empower you. Awareness is preparation, not pessimism.",
    ...
    },
    {
        ...
        "description": "Balance career, identity, and recovery without losing yourself",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Returning to work-or redefining it-can feel like learning a new language."
            ],
            "lecture": [
                "There's no such thing as 'getting back to normal.' Instead, you're integrating a new version of yourself into your professional rhythm. This module walks you through logistical and emotional prep: maternity leave planning, communication with your team, and honest conversations about capacity.",
    ...
    },
    {
        ...
        "description": "Trust your instincts-you're becoming the expert",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "There's no single 'right' way to parent-only your way."
            ],
            "lecture": [
                "Every new parent is bombarded with opinions-family, internet, strangers at Target. This module helps you develop a confident internal compass. We'll explore how intuition builds through small daily choices: how you soothe, how you feed, how you show up.",
    ...
    },
    {
        ...
        "description": "Navigate rest, rhythm, and teamwork through fatigue",
        "heroImage": "/images/academy/placeholder.jpg",
        "trackId": "postpartum",
        "content": {
            "explore": [
                "Sleep deprivation doesn't have to equal survival mode."
            ],
            "lecture": [
                "This module reframes sleep from something you lose to something you manage as a team. We explore flexible nighttime schedules, tag-teaming feedings, and building realistic rest routines around your baby's cues rather than a strict clock.",
