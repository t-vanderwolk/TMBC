  ...
  return (
    <>
      <ContainedFullWidthHero
        ...
        supporting="From registries to real-life logistics, your mentor helps you plan for pregnancy, birth, and early parenthood step by step. (We’ll hold the map. You set the pace.)"
        mobileKey="plan"
      >
