    ...
    <div className="bg-[#FFFAF8] text-[var(--tmbc-charcoal)]">
      <PageSection className="border-b border-[#D9C48E]/25">
        <div className="mx-auto max-w-screen-xl text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl text-[#3E2F35]">Learn with intention</h1>
          <p className="mt-4 text-base text-[#3E2F35]/80">
            Modules unfold over leisurely weeks. Each lesson combines quiet reflection, cultural context, and tactical next steps.
          </p>
          <div className="mt-8 flex flex-col gap-3 justify-center sm:flex-row sm:gap-4">
      ...
      <PageSection>
        <div className="mx-auto max-w-screen-xl space-y-8">
          <header className="text-center">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl text-[#3E2F35]">Lessons that feel like letters</h2>
          </header>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {topics.map((topic) => (
              ...
              >
                <h3 className="font-serif text-xl sm:text-2xl text-[#3E2F35]">{topic.title}</h3>
                <p className="mt-3 text-base text-[#3E2F35]/80">{topic.description}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <PageSection className="border-t border-[#D9C48E]/25">
        <div className="mx-auto max-w-screen-xl">
          <div className="space-y-4 rounded-[2.5rem] border border-[#D9C48E]/40 bg-white p-8 shadow-[0_15px_40px_rgba(62,47,53,0.16)]">
            ...
            <h3 className="font-serif text-2xl sm:text-3xl text-[#3E2F35]">Modules & mentorship, curated</h3>
