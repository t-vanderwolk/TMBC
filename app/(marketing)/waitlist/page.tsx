...
const WaitlistPage = () => {
  return (
    <section className="marketing-section">
      <div className="mx-auto max-w-3xl rounded-[32px] border border-[var(--tmbc-mauve)]/30 bg-white/90 p-8 shadow-[0_25px_60px_rgba(199,166,199,0.25)] text-[var(--tmbc-charcoal)]">
        <p className="text-xs uppercase tracking-[0.4em] text-[var(--tmbc-charcoal)] text-opacity-70">Waitlist</p>
        <h1 className="mt-2 text-3xl sm:text-4xl">We review every request with care.</h1>
