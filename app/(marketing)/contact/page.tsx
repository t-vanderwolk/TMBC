    ...
    <>
      ...
      <MarketingContent>
        <div className="marketing-content space-y-16 text-[var(--tmbc-charcoal)]">
          ...
          <section className="marketing-section marketing-card marketing-section-wash marketing-section-lush mx-auto max-w-2xl rounded-[32px] border border-[var(--tmbc-mauve)]/20 px-8 py-16 text-center shadow-[0_25px_70px_rgba(199,166,199,0.15)]">
