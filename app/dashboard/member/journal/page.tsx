...
export default function JournalPage() {
  ...
  const toggleShare = async (entryId: string, nextShare: boolean) => {
    ...
    try {
      await api.post('/mentor/journal/share', {
        journalId: entryId,
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-tmBlush/30 bg-white/90 p-6 shadow-sm">
          <div className="flex items-center gap-3">
            <span className="text-2xl leading-none text-tmMauve">✍️</span>
            <div>
        ...
        <div className="rounded-2xl border border-tmBlush/30 bg-white/90 p-6 shadow-sm">
          <div className="flex items-center gap-3">
            <span className="text-2xl leading-none text-tmMauve">💛</span>
            <div>
            ...
            {entries.map((entry) => (
              <div key={entry.id} className="space-y-2 rounded-2xl border border-tmBlush/30 bg-tmIvory/70 p-4">
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span className="h-3.5 w-3.5 text-tmMauve">↗</span>
